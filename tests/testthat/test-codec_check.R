test_that("check census tract id", {
  ...
  readRDS(testthat::test_path("drivetime", "drivetime.rds")) |>
    ...
    check_census_tract_id() |>
    expect_identical(
      "the census tract id column, census_tract_id_2010, does not contain every census tract for that vintage; Check for missing census tract observations and check that you are using the correct vintage."
    )
})
...
test_that("as_codec_tbl works", {
  readRDS(testthat::test_path("drivetime", "drivetime.rds")) |>
    ...
    as_codec_tbl(
      name = "foofy",
      description = "# My foofy data set \n This is a very cool data table."
    ) |>
    expect_s3_class("codec_tbl")
  ...
  readRDS(testthat::test_path("drivetime", "drivetime.rds")) |>
    ...
    expect_error("does not contain every census tract")
})
