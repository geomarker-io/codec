...
The ATSDR's [Environmental Justice Index (EJI)](https://www.atsdr.cdc.gov/placeandhealth/eji/index.html) was most recently released in 2024, but utilizes data from several older sources.
Note that although the EJI data has a `year` of 2024 in the CoDEC data package, fields in the EJI are from different sources that are each actually older.
Find the full documentation of the EJI in PDF form here: https://www.atsdr.cdc.gov/place-health/media/pdfs/2024/10/EJI_2024_Technical_Documentation.pdf
