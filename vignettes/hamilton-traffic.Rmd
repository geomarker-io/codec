...
vignette: >
  %\VignetteIndexEntry{Hamilton County Parcel and Household Traffic}
...
```{r, include = FALSE}
d <- read_tdr_csv(glue::glue("https://github.com/geomarker-io/hamilton_traffic/releases/download/v0.1.0")) |>
