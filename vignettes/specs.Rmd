...
See [Curating metadata for tabular data in R using attributes](curating-metadata.html) for details on how to save the tabular-data-resource to disk.
...
> CoDEC specifications are versioned with {CoDEC}; this article describes version `r packageVersion("codec")`.
