...
{CODECtools} comes with R scripts to generate a collection of "core" tabular-data-resources.  Source each of these to create an instance of `codec_data` in the current working directory:

```{r eval = FALSE}
library(CODECtools)

fs::path_package("CODECtools") |>
