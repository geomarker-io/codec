...
The name of the directory and the name of the CSV file containing the data MUST match the `name` [*descriptor*](codec-metadata.html#descriptor) in the [metadata](codec-metadata.html#codec-metadata-specifications).
