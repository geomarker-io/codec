...
vignette: >
  %\VignetteIndexEntry{Hamilton County Property Code Enforcement}
...
```{r, include = FALSE}
d <- read_tdr_csv("https://github.com/geomarker-io/hamilton_property_code_enforcement/releases/download/0.1.2/") |>
