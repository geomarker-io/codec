...
Community-level data are available as [CoDEC tables](./reference/as_codec_tbl.html) in this online data catalog and included with the {[codec](https://github.com/geomarker-io/codec)} R package, version `r packageVersion('codec')`:
