...
vignette: >
  %\VignetteIndexEntry{Hamilton County Landcover and Built Environment Characteristics}
...
```{r, include = FALSE}
d <- read_tdr_csv(glue::glue("https://github.com/geomarker-io/hamilton_landcover/releases/download/v0.1.0")) |>
