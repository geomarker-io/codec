...
**census tract identifer** and **year** (or *year* and *month*) columns
in a CoDEC table contain the spatiotemporal information that can be used
to link other data.
...
- Report bugs at <https://github.com/geomarker-io/codec/issues>
